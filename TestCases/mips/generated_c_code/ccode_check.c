...
int check(int ap_clk,int ap_rst,int ap_start,int dummy,int A_rom[A_MEM_SIZE],int outData_rom[outData_MEM_SIZE]){
   int A_address0=0;
...
-17,-9,0,3,5,11,22,38};*/
   ...
   if(((1 == ap_CS_fsm_state2) && (exitcond2_fu_809_p2 == 1)) == 1){
       ...
       if(reg_ce0){
       if(reg_address0 >= reg_MEM_SIZE)
	printf("reg_ram %d    %d\n",reg_ram[reg_address0],reg_address0);
   ...
   tmp_23_fu_1557_p1__temp = tmp_23_fu_1557_p1 ;
       ...
       outData_ce0 = 0;
               ...
               exitcond1_fu_826_p2 =   ( i_1_reg_720__temp  == 8 ? 1 :  0 ) ;
               funct_fu_882_p1 =   ( imem_q0__temp  & 63 ) ;
   if(((1 == ap_CS_fsm_state3) && (exitcond1_fu_826_p2 == 1)) == 1){
       ...
       if(A_ce0){
       if(A_address0 >= A_MEM_SIZE)
	printf("A_rom %d  5   %d\n",A_rom[A_address0],A_address0);
   ...
   tmp_23_fu_1557_p1__temp = tmp_23_fu_1557_p1 ;
       ...
       if(dmem_ce0){
       if(dmem_address0 >= dmem_MEM_SIZE)
	printf("dmem_ram %d    %d\n",dmem_ram[dmem_address0],dmem_address0);
   ...
   tmp_23_fu_1557_p1__temp = tmp_23_fu_1557_p1 ;
       ...
       if(1 == ap_CS_fsm_state5)
       {
          ...
          outData_address0 =  j_reg_752__temp ;
       if(imem_ce0){
       if(imem_address0 >= imem_MEM_SIZE)
	printf("imem_rom %d    %d\n",imem_rom[imem_address0],imem_address0);
   ...
   if(((1 == ap_CS_fsm_state6) && (tmp_1_fu_893_p4 == 9)) == 1){
	...
	printf("reg_ram %d    %d\n",reg_ram[reg_address0],reg_address0);
       ...
       if(reg_ce1){
       if(reg_address1 >= reg_MEM_SIZE)
	printf("reg_ram %d    %d\n",reg_ram[reg_address1],reg_address1);
   ...
   if(((1 == ap_CS_fsm_state26) && (exitcond_fu_1653_p2 == 1)) == 1){
	...
	printf("dmem_ram %d    %d\n",dmem_ram[dmem_address0],dmem_address0);
        ...
        goto end;
       if(outData_ce0){
       	if(outData_address0 >= outData_MEM_SIZE)
	printf("outData_rom %d  e  %d\n",outData_rom[outData_address0],outData_address0);
...
int main(){
   ...
   klee_print_expr("return_port:=",result);
	return 0;
}
